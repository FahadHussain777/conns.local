...
], function ($, ko, Component, confirm, customerData) {
    'use strict';
    ...
    return Component.extend({
        ...
        _toggleBind : function (anchor) {
            ...
            anchor.on('click',function (event) {
                ...
                var checkbox = $(this).siblings('input.status');
                self._toggleactive(checkbox);
            });
            var checkbox = anchor.siblings('input.status');
        ...
        _removeItem: function (id,data,event) {
            ...
            confirm({
                content : "Are you sure you want to remove this product from compare?",
                actions: {
