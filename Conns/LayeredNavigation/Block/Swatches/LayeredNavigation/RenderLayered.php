...
namespace Conns\LayeredNavigation\Block\Swatches\LayeredNavigation;
...
class RenderLayered extends MagentoRenderLayered
{
    ...
    protected $_template = 'Conns_LayeredNavigation::swatch.phtml';
    ...
    public function __construct(
        ...
        \Conns\LayeredNavigation\Model\Url\Builder $urlBuilder,
        array $data = []
    ) {
